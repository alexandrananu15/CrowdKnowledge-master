...
namespace CrowdKnowledge2.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public ActionResult Delete(string id)
        {
            ...
            var articles = db.Articole.Where(a => a.UserId == id);
            foreach (var article in articles)
            {
                db.Articole.Remove(article);
            }
            var capitole = db.Capitole.Where(comm => comm.UserId == id);
            foreach (var capitol in capitole)
            {
                db.Capitole.Remove(capitol);
            }
